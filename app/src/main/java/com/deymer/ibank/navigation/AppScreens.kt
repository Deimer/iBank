...
import com.deymer.ibank.navigation.Routes.DETAILS
...
import com.deymer.ibank.navigation.Routes.TRANSFER
...
sealed class AppScreens(val route: String) {
    ...
    object DetailsScreen: AppScreens(DETAILS)
    object TransferScreen: AppScreens(TRANSFER)
